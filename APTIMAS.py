...
username.send_keys('041604')

password = driver.find_element_by_xpath('//*[@id="password"]')
password.send_keys('K0p1h4')
#-------------------------------------------------------
...
path="D://NAJIB/APTIMAS/aptimas.xlsx"
...
for r in range(2,rows+1):
    ...
    uploadfileciptaan.send_keys("D://NAJIB/APTIMAS/FileCiptaan/"+str(fileciptaan)+".pdf")

    uploadktp = driver.find_element_by_xpath('//*[@id="ktp"]')
    uploadktp.send_keys("D://NAJIB/APTIMAS/FileKTP/"+str(ktp)+".pdf")

    uploadpernyataan = driver.find_element_by_xpath('//*[@id="file_pernyataan"]')
    uploadpernyataan.send_keys("D://NAJIB/APTIMAS/FilePernyataan/"+str(pernyataan)+".pdf")

    uploadpengalihan = driver.find_element_by_xpath('//*[@id="file_pengalihan"]')
    uploadpengalihan.send_keys("D://NAJIB/APTIMAS/FilePengalihan/"+str(pengalihan)+".pdf")
